...
class TestRemotePmacInterface(unittest.TestCase):
    ...
    @patch("dls_pmacremote.RemotePmacInterface.getNumberOfAxes")
    ...
    @patch("dls_pmacremote.RemotePmacInterface.setVar")
    @patch("dls_pmacremote.RemotePmacInterface.checkAxisIsInRange")
    ...
    @patch("dls_pmacremote.RemotePmacInterface.getIVars")
    @patch("dls_pmacremote.RemotePmacInterface.getOnboardAxisI7000PlusVarsBase")
